package com.divar.spring.core.ads.repository
...
interface AdsRepository : JpaRepository<Ads, Long> {
    fun findAllByCategoryId(id: Long, pageable: Pageable): Page<Ads>
    @Query(
        """
